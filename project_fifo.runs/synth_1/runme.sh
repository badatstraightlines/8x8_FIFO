...
HD_PWD='C:/Users/Sree/project_fifo/project_fifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_8_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_8_8.tcl
