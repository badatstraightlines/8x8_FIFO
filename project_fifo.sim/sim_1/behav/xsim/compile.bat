...
REM
REM Generated by Vivado on Mon Sep 07 11:35:36 +0530 2026
...
echo "xvlog --incr --relax -prj fifo_8_8_vlog.prj"
call xvlog  --incr --relax -prj fifo_8_8_vlog.prj -log xvlog.log
